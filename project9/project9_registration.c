...
or delete them.
*this program is modified version of project 8
*modified add_student function;  
list are kept in order by number of previous attempts in decreasing order; 
students with the same number of previous attempts are inserted in first come, first serve basis; 
*/
